...
//static ReturnCode gNfcDevFieldState( void );
...
/*******************************************************************************/
//rfalNfcState gNfcDevFieldState( void ){
//	return gNfcDev.isFieldOn;
//}
...
{
    ReturnCode err;
    rfalSetBitRate(RFAL_BR_106, RFAL_BR_106);
...
//
		...
		HAL_Delay(5000U); //how long the field stays OFF for
    }
    return;
